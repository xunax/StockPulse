...
if st.session_state.get("show_user"):
    st.markdown(f"<div style='text-align:right;'>👤 {st.session_state['username']} &nbsp;", unsafe_allow_html=True)
...
if st.session_state.get("show_settings"):
    st.markdown("<div class='settings-panel' style='background:#1a1a2e;border:2px solid #333;border-radius:16px;padding:16px 20px;margin:8px 0 16px 0;'>", unsafe_allow_html=True)
